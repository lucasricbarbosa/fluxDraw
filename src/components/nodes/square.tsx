...
export function Square({ selected, data }: NodeProps & { data?: SquareData }) {
  ...
  return (
    <div className="relative !z-40 flex h-full min-h-24 w-full min-w-36 items-center justify-center rounded bg-violet-500 p-2">
      <NodeResizer
        minWidth={144}
        minHeight={96}
        isVisible={selected}
