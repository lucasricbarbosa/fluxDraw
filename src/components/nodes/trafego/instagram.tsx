...
import instaSvg from '@/assets/insta-svg.svg';

interface SquareData {
  label?: string;
}

export function Instagram({ selected, data }: NodeProps & { data?: SquareData }) {
  const [text, setText] = useState(data?.label || "Anúncios Instagram");
