...
import pinterestSvg from '@/assets/pinterest-svg.svg';

interface SquareData {
  label?: string;
}

export function Pinterest({ selected, data }: NodeProps & { data?: SquareData }) {
  const [text, setText] = useState(data?.label || "Anúncios Pinterest");
