...
import tiktokSvg from '@/assets/tiktok-svg.svg';

interface SquareData {
  label?: string;
}

export function TikTok({ selected, data }: NodeProps & { data?: SquareData }) {
  const [text, setText] = useState(data?.label || "Anúncios TikTok");
